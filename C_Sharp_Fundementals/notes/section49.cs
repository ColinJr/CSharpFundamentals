...
//    the number. If the user guesses the number, display “You won"; otherwise, display 
//    “You lost". (To make sure the program is behaving correctly, you can display the secret number
